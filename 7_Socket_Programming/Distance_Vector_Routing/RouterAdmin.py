"""
***************************************************************************************
*    Title: RouterAdmin.py
*    Author: Ashwin V Prabhu
*    Date: May 23, 2017 (last commit)
*    Code version: 1.0
*    Availability: https://github.com/prabhuvashwin/Computer-Networks/blob/master/Distance%20Vector%20Routing/RouterAdmin.py
***************************************************************************************
(Version 1.0) [Source code]. https://github.com/prabhuvashwin/Computer-Networks/blob/master/Distance%20Vector%20Routing/RouterAdmin.py
"""
import sys
import os
import subprocess
...
def main():
    ...
    print("Initializing simulation for " +
          str(datFiles.__len__()) + " routers.")
    ...
    for i in range(datFiles.__len__()):
        ...
        subprocess.call(['python terminal.py python Router.py ' + str(i+1) +
                         ' ' + path + ' ' + str(datFiles.__len__()) + ' ' + nodes], shell=True)
        time.sleep(2)
